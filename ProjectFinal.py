...
lr.fit(x_train_preprocessed_dense, y_train)
y_pred_train = cross_val_predict(lr, x_train_prepared, y_train, cv=5) 
...
# Evaluation 
y_test_prepared=full_pip.transform(x_test)
y_pred_test=las.predict(y_test_prepared)
